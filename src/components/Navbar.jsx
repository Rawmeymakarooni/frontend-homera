...
function Navbar() {
  ...
  return (
    <nav className="fixed flex items-center justify-between pl-7 pr-1 py-1 bg-[#8B7357] text-white w-full top-0 left-0 z-50">
      ...
      {/* Menu */}
      <ul className={`flex lg:gap-10 md:static md:flex-row md:shadow-none md:bg-transparent md:w-auto md:h-full md:translate-y-0 md:p-0 md:m-0 md:transition-none gap-8 fixed ${menuActive} top-1/2 -translate-y-1/2 flex-col px-8 py-6 rounded shadow-xl bg-[#8B7357] font-bold mr-15 list-none text-sm text-white transition-all`}>
